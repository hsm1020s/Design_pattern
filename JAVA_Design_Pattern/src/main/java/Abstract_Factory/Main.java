...
public class Main {
    public static void main(String[] args) {
        if (args.length != 2) {
            ...
            System.out.println("Example 1: list33.html Abstract_Factory.listfactory.ListFactory");
            System.out.println("Example 2: div33.html Abstract_Factory.divfactory.DivFactory");
            System.exit(0);
        }
